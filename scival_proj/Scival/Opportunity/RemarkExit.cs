...
{
    public partial class RemarkExit : BaseForm
    {
                ...
                if (SharedObjects.PageIds == 10)
                {
                    if (SharedObjects.TaskId == 2 && SharedObjects.Cycle == 0)
                    {
                        try
                        {
                            ...
                            DataSet dsResult = DashboardDataOperations.TimeSheetStopContinueForQC(WFId, userId, TransId, Convert.ToInt64(SharedObjects.PageIds), remarkText);
                    ...
                    else
                    {
                        try
                        {
                            ...
                            DataSet dsResult = DashboardDataOperations.TimeSheetStopContinue(WFId, userId, TransId, Convert.ToInt64(SharedObjects.PageIds), remarkText);
