...
namespace Scival
{
    public class FTPClass
    {
        ...
        // This is an original information for FTP given by SciVal Client.
        // private string server        = "ftp.aptaracorp.com";
        // private string remotePath    = "/outgoing/sample";
        // private string username      = "elsams";
        // private string password      = "APelsams11";

        // This is a testing information for FTP used by Developers.
        private string server = "192.168.57.87";
        private string remotePath = "/pxe4g/";
        private string username = "pxe4g";
        private string password = "pxe4g@123";
        ...
        public void FtpClient(string server, string username, string password, string ServerPath)
        {
            this.server = server;
            this.username = username;
            this.password = password;
            this.remotePath = ServerPath;
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        public void FtpClient(string server, string username, string password, int timeoutSeconds, int port)
        {
            this.server = server;
            this.username = username;
            this.password = password;
